"""
Helper module containing functions to set up data splits and train the BioClinical ModernBERT transformer.
"""
import numpy as np
import torch
...
from torch.optim import AdamW  # transformers.AdamW removed in >=4.48; torch AdamW is identical
