"""
Helper for the 5-fold PEFT (QLoRA) sequence-classification runs (Qwen3.5-4B-Base /
Qwen3.5-9B-Base). IDENTICAL to the BioMistral/Med-LLaMA helper -- reuses the base
