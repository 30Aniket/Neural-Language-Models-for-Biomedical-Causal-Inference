"""
Helper for the 5-fold PEFT (QLoRA) sequence-classification runs (BioMistral-7B /
Med-LLaMA-8B). Reuses the base paper's recipe (4-bit nf4 + LoRA + paged_adamw_8bit)
and keeps get_split / predict / isotonic-calibration identical to the rest of the study.
